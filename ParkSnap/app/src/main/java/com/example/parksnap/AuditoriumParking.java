...
public class AuditoriumParking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auditorium_parking);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                outActivity.putExtra(MainActivity.LOTNAME, "Auditorium");
