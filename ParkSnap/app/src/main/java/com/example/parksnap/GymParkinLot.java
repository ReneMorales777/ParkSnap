...
public class GymParkinLot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gym_parkin_lot);
        ...
        lot[7] = (ToggleButton) findViewById(R.id.B4);
        lot[7].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b){
                    num = "B3";
                    String update = "Update AudLot Set isOccupied='1' Where spotNum = 'B4'";
                    try {
                        Connection c = DriverManager.getConnection("jdbc:sqlite:parksnap.db");
                        Statement st = c.createStatement();
                    ...
                    lot[7].setBackgroundColor(Color.GREEN);
                    i--;
                }
                else{
                    String downdate = "Update AudLot Set isOccupied='0' Where spotNum = 'B4'";
                    try {
                        Connection c = DriverManager.getConnection("jdbc:sqlite:parksnap.db");
                        Statement st = c.createStatement();
                        int count = st.executeUpdate(downdate);
                    ...
                    lot[7].setBackgroundColor(myColor);
                    i++;
                }
                spotsAvailable.setText("Spots available: " + i);
            }
        ...
        lot[11] = (ToggleButton) findViewById(R.id.C4);
        lot[11].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b){
                    num = "C4";
                    String update = "Update AudLot Set isOccupied='1' Where spotNum = 'C4'";
                    try {
                        Connection c = DriverManager.getConnection("jdbc:sqlite:parksnap.db");
                        Statement st = c.createStatement();
                    ...
                    lot[11].setBackgroundColor(Color.GREEN);
                    i--;
                }
                else{
                    String downdate = "Update AudLot Set isOccupied='0' Where spotNum = 'C4'";
                    try {
                        Connection c = DriverManager.getConnection("jdbc:sqlite:parksnap.db");
                        Statement st = c.createStatement();
                        int count = st.executeUpdate(downdate);
                    ...
                    lot[11].setBackgroundColor(myColor);
                    i++;
                }
                spotsAvailable.setText("Spots available: " + i);
            }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                outActivity.putExtra(MainActivity.LOTNAME, "Gym");
